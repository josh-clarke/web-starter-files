...
**Note:** This assumes you have done `npm -g install gulp-cli` already and have basic Gulp knowledge.  ([More info...](https://github.com/gulpjs/gulp/blob/master/docs/getting-started.md))
