...
**Note:** This assumes you have done [`npm install --global gulp-cli`](https://github.com/gulpjs/gulp/blob/master/docs/getting-started.md) already and have basic Gulp knowledge. 
